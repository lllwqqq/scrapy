...
class ZhihuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        chromePath = r'D:\scrapy\webdriver\webdriver2.3.0-chrome60\chromedriver_win32\chromedriver.exe'
        chrome_options = Options()
        chrome_options.add_argument("--headless")
        browser = webdriver.Chrome(executable_path=chromePath, chrome_options=chrome_options)

        browser.get("https://www.zhihu.com/inbox")
        # 切换到登陆
        ...
        print(browser.title)
        # 如果登陆title包含“首页”，登陆成功
        if re.search(r'私信 - 知乎', browser.title):
            print('登陆成功！！')
